import { defineComponent as b, openBlock as c, createElementBlock as p, Fragment as I, createBlock as y, resolveDynamicComponent as z, mergeProps as C, toHandlers as x, withCtx as N, renderSlot as A, resolveComponent as k, createTextVNode as yt, toDisplayString as te, defineAsyncComponent as K, createVNode as P, renderList as W, createCommentVNode as S, h as Ne, createElementVNode as H, normalizeStyle as U, normalizeClass as J, markRaw as kt } from "vue";
import { T as R, g as vt, f as St, i as $, s as Ct, r as Tt, p as wt, a as It, l as B, b as Oe, c as me, d as $t, n as Ue, e as D, h as E, j as Rt } from "./should-force-browser-runtime-in-node-ikxWrCvn.js";
...
const Wt = /* @__PURE__ */ g(xt, [["render", Vt]]), Nt = Symbol(), ce = {
  ...
  shouldLogWarning: !0
}) ? Ut(e) : Tt(e), Dt = /^(return )?(\s*)?state(?<getPath>(\.\w+)+)(\s*);?$/, Lt = /(\s)*var(\s)+_virtual_index(\s)*=(\s)*state(?<getPath>(\.\w+)+)(\s*);?(\s)*return(\s)*_virtual_index(\s)*/, Ht = (e) => {
  var t, n, o, r, s, i;
...
const Qe = (e) => {
  ...
  value: t,
  canTrack: !0
}), _e = (e) => D(e.id) && D(e.variations) && Object.keys(e.variations).length > 0, In = ({
  id: e,
  variations: t
}) => {
  var r;
...
const Vn = "v3", Be = (e) => typeof e == "number" && !isNaN(e) && e >= 0, ye = (e) => {
  ...
  const bt = t !== 1, gt = F || "https://cdn.builder.io", w = new URL(`${gt}/api/${a}/content/${r}`);
...
const ct = (e, t) => e ? t ? e.models && e.models.length > 0 && !e.models.includes(t) : !1 : !0, qn = ({
  block: e,
...
}), _n = () => import("./block-styles-cdBFFodd.js").then((e) => e.default).catch((e) => {
  throw console.error(
    "Error while attempting to dynamically import component BlockStyles at ./components/block-styles.vue",
    e
  ), e;
}), eo = () => import("./block-wrapper-QLQ8QCsB.js").then((e) => e.default).catch((e) => {
  throw console.error(
    "Error while attempting to dynamically import component BlockWrapper at ./components/block-wrapper.vue",
    e
  ), e;
}), to = () => import("./component-ref-_3BRwWYE.js").then((e) => e.default).catch((e) => {
  throw console.error(
    "Error while attempting to dynamically import component ComponentRef at ./components/component-ref/component-ref.vue",
    e
  ), e;
}), no = () => import("./repeated-block-5xUjwB4K.js").then((e) => e.default).catch((e) => {
  throw console.error(
...
const ao = /* @__PURE__ */ g(so, [["render", io], ["__scopeId", "data-v-e05fb921"]]), lo = b({
  name: "builder-blocks",
...
}), Io = ["srcset"], $o = ["loading", "fetchpriority", "alt", "title", "role", "src", "srcset", "sizes"], Ro = {
  key: 2,
...
const Po = /* @__PURE__ */ g(wo, [["render", Eo], ["__scopeId", "data-v-717bf141"]]), Bo = b({
...
const Fo = /* @__PURE__ */ g(No, [["render", Uo]]), Do = {
  name: "Core:Button",
...
const Go = /* @__PURE__ */ g(qo, [["render", Jo]]), Yo = {
  name: "Symbol",
  noWrap: !0,
  static: !0,
  isRSC: !0,
...
const Ur = /* @__PURE__ */ g(Vr, [["render", Or]]), Fr = {
  name: "Form:SubmitButton",
...
const ss = /* @__PURE__ */ g(_r, [["render", rs]]), is = () => [{
  component: ur,
  ...ar
}, {
  component: yr,
...
const Us = /* @__PURE__ */ g(Ns, [["render", Os]]), Fs = b({
...
const Ls = /* @__PURE__ */ g(Fs, [["render", Ds]]), Hs = async ({
